...
const AuthScreen = ({ auth, setNotification }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!auth) {
            setNotification({ message: 'Servizio di autenticazione non pronto.', type: 'error' });
            return;
        }
        setIsLoading(true);
        try {
        ...
        <div className="min-h-screen bg-gray-100 flex flex-col justify-center items-center p-4">
            <div className="max-w-md w-full bg-white shadow-md rounded-lg p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        <button type="submit" disabled={isLoading || !auth} className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:bg-blue-300">
...
export default function App() {
    ...
    // State for Firebase instances and config errors
    ...
    if (!isAuthReady) {
        return <div className="h-screen w-screen flex justify-center items-center bg-gray-100"><div className="animate-spin rounded-full h-16 w-16 border-t-2 border-b-2 border-blue-500 mr-4"></div><div className="text-xl font-semibold">Inizializzazione...</div></div>;
    }
         ...
         return (
             <div className="h-screen w-screen flex flex-col justify-center items-center bg-gray-100 p-4">
                 <div className="max-w-md w-full bg-white shadow-md rounded-lg p-8 text-center">
                     ...
                     <p className="text-gray-500 mt-2 text-sm">Controlla la console per maggiori dettagli e assicurati che le credenziali siano fornite.</p>
                 </div>
             </div>
         );
    }
