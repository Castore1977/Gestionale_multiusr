...
                                                />
                                            )}
                                            {/* NUOVO: Indicatore di spostamento per attività ripianificate */}
                                            {isPlaceholderVisible && (() => {
                                                ...
                                                return (
                                                    <div
                                                        className="absolute top-1/2 -translate-y-1/2 h-px border-t border-dashed border-yellow-600 z-10"
                                                        style={{
                                                            left: `${lineStart}px`,
                                                            width: `${lineWidth}px`,
                                                        }}
